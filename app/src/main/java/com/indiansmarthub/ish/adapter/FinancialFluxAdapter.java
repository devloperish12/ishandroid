...
public class FinancialFluxAdapter extends RecyclerView.Adapter<FinancialFluxAdapter.FinancialFluxHolder> {
    ...
    public FinancialFluxAdapter(Context context, JSONArray finalFinancialFlux, String url, onItemCLickListner listner) {
...
//                });
    ...
    public class FinancialFluxHolder extends RecyclerView.ViewHolder {
        ImageView ivProductImage, iv_minus_EduBasket, iv_plus_EduBasket,ivWishlistRemove,IvWishListAdd;
        ...
        public FinancialFluxHolder(@NonNull View itemView) {
            ...
            IvWishListAdd=itemView.findViewById(R.id.ivWishListAddhome);
            ivWishlistRemove=itemView.findViewById(R.id.ivWishListRemovehome);
