...
public class AllServicesAdapterCreativeGallery extends RecyclerView.Adapter<AllServicesAdapterCreativeGallery.MyViewHolder> {
    Context context;
    List<Category> serviceedu;
    JSONArray jsonArray;
    String url;

    public AllServicesAdapterCreativeGallery(Context context, JSONArray jsonArray, String url) {
        this.context = context;
        this.serviceedu = serviceedu;
    ...
    @NonNull
    @Override
    public AllServicesAdapterCreativeGallery.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.sub_category_layout, parent, false);
        return new AllServicesAdapterCreativeGallery.MyViewHolder(itemView);
    }
