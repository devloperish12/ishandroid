...
public class AllServicesAdapterMall extends RecyclerView.Adapter<AllServicesAdapterMall.MyViewHolder> {
    Context context;
    List<Category> serviceedu;
    JSONArray jsonArray;
    String url;

    public AllServicesAdapterMall(Context context, JSONArray jsonArray,String url) {
    ...
    @NonNull
    @Override
    public AllServicesAdapterMall.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.sub_category_layout, parent, false);
        return new AllServicesAdapterMall.MyViewHolder(itemView);
    }
